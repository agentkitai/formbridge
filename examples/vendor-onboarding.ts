/**
 * Example Intake Definition: Vendor Onboarding
 *
 * This example demonstrates a production-grade vendor onboarding intake
 * with mixed-mode collaboration (agent + human), file uploads, and
 ...
 *
 * Flow:
 * 1. Agent pre-fills known vendor data (name, email, country)
 * 2. System validates and identifies missing fields (tax_id, documents)
 * 3. Agent hands off to vendor via web form link
 * 4. Vendor fills remaining fields and uploads documents
 * 5. Agent resumes and submits
 * 6. Compliance team reviews and approves
  ...
  approvalGates: [
    {
      ...
      requiredApprovals: 1,
      escalateAfterMs: 86400000, // 24 hours
    },
  ],
