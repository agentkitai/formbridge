 ...
 *
 * This example demonstrates a realistic vendor onboarding intake form with
 * 10+ fields including nested objects, enums, and various validation constraints.
 * It showcases how FormBridge generates MCP tool servers from IntakeSchema definitions.
 */
...
/**
 * Vendor onboarding Zod schema
 *
 * Defines the structure and validation rules for vendor onboarding submissions.
 * Includes personal info, business details, banking information, and required documents.
 */
...
/**
 * Complete IntakeDefinition for vendor onboarding
 *
 * This definition includes the schema, approval gates for high-value vendors,
 * and destination configuration for webhook delivery.
 */
